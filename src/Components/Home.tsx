...
const Home = () => {
    const { postsInfo, handlePageChange, currentPage, loading } = usePost();
    ...
    return (
        <>
            <h1 data-testid="header" style={{ textAlign: "center" }}>
                Post List
            </h1>
            {loading && (
                <Box
            ...
            <Container style={{ maxWidth: "100%" }}>
                <Paper>
                    ...
                    <Pagination
                        data-testid="pagePagination"
                        count={parseInt(
                            (postsInfo?.length / pageSize).toString()
                        )}
                        page={currentPage}
